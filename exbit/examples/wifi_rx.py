...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.window_size = window_size = 160
        self.sync_length = sync_length = 640
        self.samp_rate = samp_rate = 40e6
        self.lo_offset = lo_offset = 0
        self.gain = gain = 0.95
        self.freq = freq = 5620000000
        ...
        self._samp_rate_options = [5e6, 10e6, 20e6, 40e6]
        # Create the labels list
        self._samp_rate_labels = ["5 MHz", "10 MHz", "20 MHz", "40 MHz"]
        ...
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(0.97, 64, False, False)
        ...
        self.fft_vxx_0 = fft.fft_vcc(128, True, window.rectangular(128), True, 1)
        ...
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(window_size  +32, window_size / (window_size+32), 4000, 1)
        self.blocks_divide_xx_0 = blocks.divide_ff(1)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 32)
    ...
    def set_window_size(self, window_size):
        ...
        self.blocks_moving_average_xx_0.set_length_and_scale(self.window_size  +32, self.window_size / (self.window_size+32))
