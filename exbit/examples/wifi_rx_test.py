...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.window_size = window_size = 80
        self.sync_length = sync_length = 320
        self.samp_rate = samp_rate = 20e6
        self.lo_offset = lo_offset = 0
        self.gain = gain = 0.9
        self.freq = freq = 5745000000
        ...
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(0.97, 32, False, False)
        ...
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(window_size  + 16, window_size / (window_size+16), 4000, 1)
    ...
    def set_window_size(self, window_size):
        ...
        self.blocks_moving_average_xx_0.set_length_and_scale(self.window_size  + 16, self.window_size / (self.window_size+16))
